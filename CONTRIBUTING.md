...
> ### Предупреждение!
> В случае если сервис должен использоваться в связке с другими сервисами, в том числе сервисом transactions, миграции нужно производить из сервиса transactions.

Для запуска миграций активируйте
